...
public class Clock : MonoBehaviour
{
    ...
    [SerializeField]
    private Vector3 hourMinuteSecond = new Vector3(6f, 0f, 0f),
                                        hmsSunSet = new Vector3(18f, 0f, 0f);
    ...
    [SerializeField]
    private Vector3 hmsStarsLight = new Vector3(19f, 30f, 0f),
    ...
    void Update()
    {
        ...
        rotation = (time - 21600f) / 86400f * 360f; // 86400 / 4 = 2160
        ...
        else if (time < 43200f) intensity = intensityAtSunSet + (intensityAtNoon - intensityAtSunSet) * (time - sunRise) / (443200f - sunRise);
        else if (time < sunSet) intensity = intensityAtNoon - (intensityAtNoon - intensityAtSunSet) * (time - 43200f) / (sunSet - 43200f);
        else intensity = intensity - (1f - intensityAtSunSet) * (time - sunSet) / (84600f - sunSet);
