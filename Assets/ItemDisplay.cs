            ...
            if(Inventory.instance.inventories.Count != 0)
            {
                if(Hotkey <= Inventory.instance.inventories.Count)
                {
                    if (Inventory.instance.inventories[Hotkey - 1] != null)
                    {
                        ...
                        var theObj = Instantiate(Inventory.instance.inventories[Hotkey - 1].itemObj, _Player.position, Quaternion.identity);
                        ...
                        Inventory.instance.inventories.Remove(Inventory.instance.inventories[Hotkey - 1]);
